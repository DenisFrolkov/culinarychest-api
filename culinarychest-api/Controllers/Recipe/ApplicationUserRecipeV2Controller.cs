...
[ApiVersion("2.0")]
[Route("api/{v:apiversion}/applicationUser/recipe")]
[ApiController]
public class ApplicationUserRecipeV2Controller : ControllerBase
{
    ...
    public ApplicationUserRecipeV2Controller(IRepositoryManager repository, ILoggerManager logger, IMapper mapper, UserManager<ApplicationUser> userManager)
    {
